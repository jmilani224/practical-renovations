...
import { Box, Grid, Divider, Avatar, Flex, Text, Tag } from '@chakra-ui/core'
        ...
        <Layout>
            ...
            >
                ...
                >
                    ...
                    <Box mb={4}>
                      <FluidImageHandler fluid={doc.node.hero_imageSharp.childImageSharp.fixed} fallbackImage={doc.node.hero_image.url} alt={doc.node.hero_image.alt} />
                    </Box>
                    <LongFormText>
                ...
                >
                    ...
                    alignItems="center"
                    >
                        <Avatar name="Jesse Carter" src="https://bit.ly/sage-adebayo" size="2xl" />
                        <SideBarVerticalSpace>
                            <SidebarText>
                                <Box
                                pl={6}
